...
class Announcement extends amplify_core.Model {
  ...
  String toString() {
    ...
    buffer.write(
        "creator=" + (_creator != null ? _creator!.toString() : "null") + ", ");
    buffer.write(
        "mosque=" + (_mosque != null ? _mosque!.toString() : "null") + ", ");
      ...
      : id = json['id'],
        ...
        _creator = json['creator']?['serializedData'] != null
            ? User.fromJson(new Map<String, dynamic>.from(
                json['creator']['serializedData']))
            : null,
        _mosque = json['mosque']?['serializedData'] != null
            ? Mosque.fromJson(
                new Map<String, dynamic>.from(json['mosque']['serializedData']))
            : null,
  ...
  Map<String, dynamic> toJson() => {
        ...
        'body': _body,
        'images': _images,
        'creator': _creator?.toJson(),
        'mosque': _mosque?.toJson(),
  ...
  static final amplify_core.QueryModelIdentifier<AnnouncementModelIdentifier>
      MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<AnnouncementModelIdentifier>();
 ...
 */
class AnnouncementModelIdentifier
    implements amplify_core.ModelIdentifier<Announcement> {
  final String id;
