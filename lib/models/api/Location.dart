...
class Location {
  ...
  const Location._internal({required addressLine1, addressLine2, addressLine3, required city, required province, required postalCode, required country, required latitude, required longitude}): _addressLine1 = addressLine1, _addressLine2 = addressLine2, _addressLine3 = addressLine3, _city = city, _province = province, _postalCode = postalCode, _country = country, _latitude = latitude, _longitude = longitude;
  
  factory Location({required String addressLine1, String? addressLine2, String? addressLine3, required String city, required String province, required String postalCode, required String country, required double latitude, required double longitude}) {
  ...
  Location copyWith({String? addressLine1, String? addressLine2, String? addressLine3, String? city, String? province, String? postalCode, String? country, double? latitude, double? longitude}) {
    return Location._internal(
